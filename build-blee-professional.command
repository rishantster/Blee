...
EXPECTED_APK="Blee-2.5.0-mesh-v2-debug.apk"
...
echo "============================================================"
echo "Building Blee 2.5 — biometric unlock / notifications / launch polish"
echo "============================================================"
echo "Architecture: ARCHITECTURE.md"
echo "UI contract: UI_ARCHITECTURE.md"
echo "Brand: supplied Blee wordmark + mark"
bash "$INNER_BUILDER"

APK="$ROOT/dist/$EXPECTED_APK"
[ -f "$APK" ] || { echo "ERROR: Blee 2.5 APK was not produced: $APK"; exit 1; }
...
echo
echo "Blee 2.5 Mesh v2 build complete:"
echo "$APK"
