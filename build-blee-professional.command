...
replacements = {
    'APP_NAME="Blee-1.1.1-storage-fixed-debug.apk"': 'APP_NAME="Blee-1.2.0-professional-debug.apk"',
    "g=re.sub(r'versionCode\\s+\\d+', 'versionCode 4', g)": "g=re.sub(r'versionCode\\s+\\d+', 'versionCode 5', g)",
    "g=re.sub(r'versionName\\s+\"[^\"]+\"', 'versionName \"1.1.1\"', g)": "g=re.sub(r'versionName\\s+\"[^\"]+\"', 'versionName \"1.2.0\"', g)",
    "print('Blee 1.1.1 launcher identity and version verified.')": "print('Blee 1.2.0 launcher identity and version verified.')",
}
...
addition = anchor + '''\necho "Applying Blee 1.2 professional hardening + UX..."\npython3 scripts/apply-blee-professional.py\n'''
...
echo "============================================================"
echo "Building Blee 1.2 Professional"
echo "============================================================"
bash "$INNER_BUILDER"
...
echo
echo "Blee 1.2 Professional build complete:"
echo "$APK"
