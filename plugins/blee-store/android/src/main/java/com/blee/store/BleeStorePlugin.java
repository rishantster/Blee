...
public class BleeStorePlugin extends Plugin {
    ...
    private static final String STORE_MARKER = "BLEE_STORE_MESH_V2_ATOMIC_SIGNING_V2";
    ...
    public void reserveSigningIntent(PluginCall call) {
        ...
        try {
            ...
            Long chain = readLong(call, "chainId");
            ...
            Long expiresAt = readLong(call, "expiresAt");
            Long minTxNonce = readLong(call, "minTxNonce");
    ...
    // BLEE_SENT_NOTIFICATION_BRIDGE_V1
    ...
    private void dispatchSentNotification(JSONObject notice) {
        try {
            ...
            service.setClassName("com.blee.payments", "com.blee.payments.BleeMeshService");
            service.setAction("com.blee.payments.BLEE_LOCAL_PAYMENT_SENT");
