...
public class BleeBiometricPlugin extends Plugin {
    private static final String PREFS = "blee.biometric.v1";
    private static final String PREF_CIPHER = "ciphertext";
    private static final String PREF_IV = "iv";
    private static final String KEY_ALIAS = "blee.biometric.passphrase.v1";
    ...
    public void unlock(PluginCall call) {
        ...
        try {
            ...
            if (key == null) {
                clearCredential();
                call.reject("Fingerprint unlock must be enabled again");
                return;
            }
            Cipher cipher = Cipher.getInstance(TRANSFORMATION);
            ...
            authenticate(
                ...
                authenticatedCipher -> {
                    try {
                        byte[] plaintext = authenticatedCipher.doFinal(Base64.decode(cipherText, Base64.NO_WRAP));
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                if (result != BiometricManager.BIOMETRIC_SUCCESS) {
                    return new Availability(false, true, "Strong fingerprint authentication is unavailable on this phone");
                }
            }
