...
def main() -> None:
    ...
    # those three narrow pieces and leave every other hardening change intact.
    ...
    # BLE v4 should now see exactly the anchors it owns and will re-add the
    # stronger independent advertising state itself.
    required = (
