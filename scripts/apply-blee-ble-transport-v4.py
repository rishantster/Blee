    ...
    start_bluetooth = r'''    private void startBluetooth() {
        ...
        try {
            ...
            if (advertiser != null && !advertising && !advertiseStarting && now >= nextAdvertiseAttemptAt) {
                // Some Android controllers share resources between central
                // scanning and peripheral advertising. Serialize advertiser
                // allocation instead of racing it with startScan().
